...
function Gamex() {
  ...
  return (
    <div id="gamex" className='mb-20 '>
        ...
        <div onClick={() => router.push("https://gamex.vercel.app/")} className='flex justify-evenly cursor-pointer mr-5 ml-5 object-contain overflow-x-hidden '>
        ...
        <div onClick={() => router.push("https://gamex.vercel.app/")} className="w-full cursor-pointer lg:w-6/12 px-4 ml-auto mr-auto text-center">
