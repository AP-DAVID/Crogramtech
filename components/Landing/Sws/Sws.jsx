  ...
  return (
    <div id="sws" className='mt-20'>
        ...
        <div  className='flex cursor-pointer justify-center w-full '>
            <div onClick={() => router.push("https://umisexample.vercel.app/") } className="sm:px-5  sm:mr:10  justify-items-stretch sm:gap-5 space-y-2 sm:space-y-0  sm:grid sm:grid:cols-2 md:grid:cols-2 lg:grid-cols-2 xl:grid-cols-2 3xl:flex flex-wrap justify-center">
        ...
        <div onClick={() => router.push("https://umisexample.vercel.app/") } className='flex cursor-pointer justify-center'>
            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
